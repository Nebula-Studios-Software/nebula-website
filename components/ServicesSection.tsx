			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					...
					>
						...
						<p className="text-muted-foreground">{dict.items.web.description}</p>
					</MotionDiv>
					...
					>
						...
						<h3 className="font-medium text-xl mb-2">{dict.items.design.title}</h3>
						<p className="text-muted-foreground">{dict.items.design.description}</p>
					</MotionDiv>
					...
					>
						...
						<h3 className="font-medium text-xl mb-2">{dict.items.strategy.title}</h3>
						<p className="text-muted-foreground">{dict.items.strategy.description}</p>
					</MotionDiv>
				</div>
			</div>
		</section>
