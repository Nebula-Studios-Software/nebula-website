...
const About = ({ dictionary }: { dictionary: any }) => {
	return (
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					>
						<motion.div variants={fadeIn}>
							...
							<div className="space-y-4 text-muted-foreground">
								...
								<p>
									As we've grown, our commitment to quality and innovation has remained
									at the core of everything we do. We're proud to have worked with
									clients across various industries, helping them achieve their digital
									goals and create meaningful connections with their audiences.
								</p>
							</div>
						</motion.div>
					...
					>
						...
						<p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
							...
							If you're passionate about digital innovation and want to work in a
							collaborative and creative environment, check out our current openings.
						</p>
