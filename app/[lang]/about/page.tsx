        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeIn}>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded in 2018, Nebula Studios began with a simple mission:
                  to create digital experiences that are both beautiful and
                  functional. What started as a small team of three passionate
                  individuals has grown into a diverse group of talented
                  professionals.
                </p>
                <p>
                  We believe that great design and technology should be
                  accessible to businesses of all sizes. Our approach combines
                  creativity with technical expertise to deliver solutions that
                  not only look great but also drive real results for our
                  clients.
                </p>
                <p>
                  As we&apos;ve grown, our commitment to quality and innovation
                  has remained at the core of everything we do. We&apos;re proud
                  to have worked with clients across various industries, helping
                  them achieve their digital goals and create meaningful
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  both within our team and with our clients. Together, we create
                  better outcomes than any of us could achieve alone.
                </p>
              </div>
              <div className="glass-card rounded-xl p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  everything we do, from the code we write to the designs we
                  create and the service we provide to our clients.
                </p>
              </div>
            </div>
          </motion.div>
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="text-nebula-400 text-sm mb-3">
                      {member.role}
                    </div>
          ...
          >
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              ...
              growing team. If you&apos;re passionate about digital innovation
              and want to work in a collaborative and creative environment,
